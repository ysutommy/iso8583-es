...
export default class ISOField {
	private static ZS: String = "0000000000000000000000000000000000000000";
	private static ES: String = "                                        ";
	// 域索引
	...
	// 长度的长度 LLL-3 LL-2 L-1
	private readonly varLen: number;
	// 域类型
	private readonly type: String;
	// 是否压缩
	public readonly compress: Boolean;

	constructor(fieldInfo: String, compress: Boolean = true) {
	 ...
	 * @param compress 是否压缩
	 */
	public static makeFields(fieldDefinition: String, compress: Boolean): Array<ISOField> {
		const fields = new Array<ISOField>(129)
